...
//console.log(user._id);
  ...
  const loggedInUserId = user?._id; // Access logged-in user's ID from Redux
  ...
  useEffect(() => {
    socket.emit("join_room", connection._id); // Join the room for this connection
    ...
    return () => {
      ...
      socket.emit("leave_room", connection._id); // Leave room on unmount
    };
  }, [connection._id]);
